...
<asp:Content ID="about_page" ContentPlaceHolderID="main_content" runat="server">
    <div class="row"> 
        <div class="col-lg-4">
            <br />
            <a href="#volunteer_form" class=" btn btn-outline-primary" role="button" aria-pressed="true">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            tortor. Etiam vehicula laoreet est in luctus.</p> </div>
        <div class="col-lg-2"> 
...
<div class="col-lg-4">
  ...
  <div class="card card-body">
   ...
   <div class="row"> 
      <div class="col-lg-2"> </div>
        <div class="col-lg-8"> 
        <h1> Citizen Science Volunteer Form </h1>
             </div>
                <div class="col-lg-2"> </div>
         </div>
    ...
    <div class="row">
        <div class="col-lg-2"> </div>
        <div class="col-lg-8">
        <h4> Please fill out the form below if you are interested in volunteering. </h4>
             </div>
         <div class="col-lg-2"> </div>
           </div>
    <div class="row">
    <div class="col-lg-2"></div>
    <div id="form1" class="col-lg-8" style="text-align:center;">
  <div class="form-row">
